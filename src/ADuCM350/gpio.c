 ...
 *****************************************************************************
   ...
   @date:    $Date: 2015-12-03 03:48:53 -0500 (Thu, 03 Dec 2015) $
*/
/*****************************************************************************/
...
/*!
    @brief      Register or unregister an application callback function for external pin interrupts 
                or Group A/B interrupts.

    @details    Applications may register a callback function that will be called when an
                external interrupt or Group A/B interrupt occurs. In addition to registering the 
                interrupt, the application should enable interrupt. For external pin interrupt it should
                call the #adi_GPIO_EnableIRQ API. For Group A/B interrupt application should call the 
                NVIC_EnableIRQ API.
